...
plugins=(git brew pip python github command-not-found history git-flow-avh vi-mode)

source $ZSH/oh-my-zsh.sh

# User configuration

export PATH="/usr/local/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/usr/texbin:/Users/leonardtruong/aspire/riscv/riscv/bin"
